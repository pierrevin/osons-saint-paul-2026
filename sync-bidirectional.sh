...
# Récupère les modifications de production ET les intègre à Git
...
# Étape 1: Récupérer les modifications d'OVH
log_info "Étape 1: Récupération des modifications d'OVH..."
git fetch origin
...
if ! git diff-index --quiet HEAD --; then
    git stash push -m "Sauvegarde avant sync bidirectionnelle - $(date)"
    log_info "✅ Modifications locales sauvegardées"
fi

# Étape 3: Fusionner les modifications d'OVH
log_info "Étape 3: Fusion des modifications d'OVH..."
git pull origin main

# Étape 4: Restaurer les modifications locales
log_info "Étape 4: Restauration des modifications locales..."
if git stash list | grep -q "Sauvegarde avant sync bidirectionnelle"; then
    git stash pop
...
log_info "✅ Synchronisation bidirectionnelle terminée !"
echo ""
echo "📊 Résumé :"
