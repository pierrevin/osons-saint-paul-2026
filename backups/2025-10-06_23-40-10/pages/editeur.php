...
// Vérifier que l'utilisateur est éditeur ou admin
if (!isset($_SESSION['user_role']) || !in_array($_SESSION['user_role'], ['editeur', 'admin'])) {
...
// Initialiser les sections (limitées pour les éditeurs)
$sections = [
...
<head>
    ...
    <script>
        ...
        function navigateToSection(sectionId) {
            console.log('🚀 FONCTION APPELÉE - Navigation vers:', sectionId);
            ...
            console.error('❌ AdminCore.navigateTo indisponible. Aucune navigation fallback maintenue.');
        }
        ...
        function editProposal(id) {
            ...
            console.log('Édition de la proposition:', id);
        ...
        function setCitizenProposalStatus(proposalId, status) {
            console.log('🔄 setCitizenProposalStatus appelée avec:', { proposalId, status });
            const statusText = status === 'pending' ? 'en attente' : 'rejetée';
            if (confirm(`Êtes-vous sûr de vouloir mettre cette proposition ${statusText} ?`)) {
                ...
                `;
                document.body.appendChild(form);
                console.log('📝 Formulaire créé et soumis');
                form.submit();
            } else {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('🚀 DOM chargé, navigateToSection disponible:', typeof navigateToSection);
            console.log('🚀 AdminModal disponible:', typeof AdminModal);
            
            // Debug : vérifier les éléments du menu
            const menuItems = document.querySelectorAll('.menu-item a');
            console.log('📋 Éléments de menu trouvés:', menuItems.length);
            ...
            setTimeout(() => {
                ...
                console.log('🚀 Page admin chargée, affichage de la section:', section);
