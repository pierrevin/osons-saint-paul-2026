<?php
/**
 * Interface d'administration - Version monolithique (DÉSACTIVÉE)
 * 
 * ⚠️ ATTENTION: Ce fichier est désactivé et sera supprimé prochainement.
 * Utilisez schema_admin_new.php à la place.
 */

// Désactiver l'accès à l'ancien système
...
<head>
    ...
    <title>Interface désactivée</title>
    <style>
...
<body>
    <div class="container">
        <h1>🚫 Interface désactivée</h1>
        <p>L\'ancienne interface d\'administration a été désactivée pour des raisons de sécurité et de maintenance.</p>
        <p>Veuillez utiliser la nouvelle interface d\'administration.</p>
        <a href="schema_admin_new.php" class="btn">→ Nouvelle interface admin</a>
        <a href="editeur.php" class="btn">→ Interface éditeur</a>
    </div>
</body>
</html>
');
