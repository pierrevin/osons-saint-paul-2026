...
class AdminTabs {
    ...
    switchTo(tabName) {try {
            ...
            this.onTabChange(tabName);} catch (error) {}
    }
    ...
    loadCitizenProposals() {const container = document.getElementById('citizen-proposals-container');
        if (!container) {
            return;
        }
    ...
    refreshProgrammeProposals() {// Logique d'actualisation si nécessaire
    }
