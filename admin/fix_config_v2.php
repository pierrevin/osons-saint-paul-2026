<?php
/**
 * Script de correction rapide pour config.php - Version 2
 * 
...
echo '<h2>🔧 Correction config.php - Version 2</h2>';
echo '<hr>';
...
if (strpos($config_content, 'function check_auth') !== false) {
    ...
    // Créer le contenu de la fonction avec les bonnes échappements
    $function_content = "\n\n// Fonction d'authentification\nfunction check_auth() {\n    if (!isset(\$_SESSION['admin_logged_in']) || \$_SESSION['admin_logged_in'] !== true) {\n        header('Location: ../login.php');\n        exit;\n    }\n}";
    
    // Ajouter la fonction
    $new_content = $config_content . $function_content;
...
echo '<p><strong>SUPPRIMEZ ce fichier fix_config_v2.php maintenant !</strong></p>';
echo '<p>Ce script ne doit plus être accessible après correction.</p>';
echo '</div>';

echo '<hr>';
echo '<p><small>Script de correction v2 - Osons Saint-Paul 2026</small></p>';
?>
